# 03 — Контракты, артефакты и границы доверия

Status: outline; lecture not written

Track: core

[Todo-план](../../../plan/steps/lections/LECTURE-0003-contracts.md) · [Manifest](../../manifest.json) · [Технические требования](../../technical-requirements.md)

## Место и prerequisites

[1](../../modules/module-01-organization/README.md)
...
Будущий текст: `course/lectures/LECTURE-0003-contracts.md`; outline не лекция.
