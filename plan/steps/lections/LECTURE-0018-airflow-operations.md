...
- [x] Развести data-task scheduling и orchestration reasoning агентов.
- [x] Объяснить stable REST /api/v2 vs Task Execution API без смешения двух интерфейсов.
- [x] Показать observer GET scope и separate approved dev-DAG trigger identity.
- [x] Применить понятие operation identity из 17; не переобъяснять idempotency protocol и общий threat model.
