# TODO — Лекция 03. Контракты, артефакты и границы доверия

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0003-contracts.md` (ещё не написан).
...
Не пересказывать theory владельцев: [10](LECTURE-0010-pm-specification.md), [12](LECTURE-0012-data-engineer.md), [15](LECTURE-0015-strict-workflow.md).
