# 05 — Изоляция среды исполнения

Status: outline; lecture not written

Track: core

[Todo-план](../../../plan/steps/lections/LECTURE-0005-isolation.md) · [Manifest](../../manifest.json) · [Технические требования](../../technical-requirements.md)
...
Будущий текст: `course/lectures/LECTURE-0005-isolation.md`; outline не лекция.
