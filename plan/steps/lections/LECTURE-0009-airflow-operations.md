# TODO — Лекция 09. Airflow API: наблюдение и контролируемые операции

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0009-airflow-operations.md` (ещё не написан).
...
Prerequisites: [06](LECTURE-0006-mcp-interface.md), [18](LECTURE-0018-recovery-idempotency.md).
...
Не пересказывать theory владельцев: [15](LECTURE-0015-strict-workflow.md), [18](LECTURE-0018-recovery-idempotency.md), [19](LECTURE-0019-security-authority.md).
