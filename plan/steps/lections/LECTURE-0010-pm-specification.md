# TODO — Лекция 10. PM: формальная спецификация и пределы знания

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0010-pm-specification.md` (ещё не написан).
...
Prerequisites: [11](LECTURE-0011-analyst-provenance.md).
...
Не пересказывать theory владельцев: [11](LECTURE-0011-analyst-provenance.md), [12](LECTURE-0012-data-engineer.md), [15](LECTURE-0015-strict-workflow.md).
