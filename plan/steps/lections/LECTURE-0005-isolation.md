# TODO — Лекция 05. Изоляция среды исполнения

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0005-isolation.md` (ещё не написан).
...
Не пересказывать theory владельцев: [19](LECTURE-0019-security-authority.md), [24](LECTURE-0024-deployment-theory.md).
