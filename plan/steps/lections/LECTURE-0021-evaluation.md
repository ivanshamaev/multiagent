...
Текст: `course/lectures/LECTURE-0021-evaluation.md`.
...
- [x] Определить task/trial/grader/outcome и единицу измерения reliability.
- [x] Развести offline invariants, dated live model rates и статистическое сравнение fresh samples.
- [x] Разобрать false pass/false approval, выборку/доверие, contamination и ограничения малого N.
- [x] Показать 17×3 harness и DE historical sample; путь dynamic manager оценивать не по идентичности trajectory.
