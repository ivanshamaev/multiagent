# TODO — Лекция 15. Жёсткий workflow: reducer, branching и convergence

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0015-strict-workflow.md` (ещё не написан).
...
Prerequisites: [02](LECTURE-0002-maf-executors.md).
...
Не пересказывать theory владельцев: [02](LECTURE-0002-maf-executors.md), [16](LECTURE-0016-agent-orchestrator.md), [18](LECTURE-0018-recovery-idempotency.md), [26](LECTURE-0026-orchestration-comparison.md).
