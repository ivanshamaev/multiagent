# 18 — Recovery: checkpoints, receipts и пределы exactly-once

Status: outline; lecture not written

Track: core

[Todo-план](../../../plan/steps/lections/LECTURE-0018-recovery-idempotency.md) · [Manifest](../../manifest.json) · [Технические требования](../../technical-requirements.md)

## Место и prerequisites

[15](../../modules/module-15-strict-workflow/README.md), [17](../../modules/module-17-state-memory/README.md)
...
Будущий текст: `course/lectures/LECTURE-0018-recovery-idempotency.md`; outline не лекция.
