...
Текст: `course/lectures/LECTURE-0008-isolation.md`.
...
- [x] Развести prompt-level restrictions и физические границы исполнения.
- [x] Объяснить process/filesystem/network namespaces, scoped mounts и fail-closed behavior.
- [x] Показать five Bubblewrap role identities, trusted model transport и нулевой raw egress.
- [x] Разобрать ограничение shared kernel; authentication и Kubernetes вынести в отдельные лекции.
