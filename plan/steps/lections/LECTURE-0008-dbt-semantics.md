# TODO — Лекция 08. dbt, lineage и семантика аналитической модели

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0008-dbt-semantics.md` (ещё не написан).
...
Prerequisites: [07](LECTURE-0007-analytical-sql.md).
...
Не пересказывать theory владельцев: [09](LECTURE-0009-airflow-operations.md), [11](LECTURE-0011-analyst-provenance.md), [12](LECTURE-0012-data-engineer.md), [13](LECTURE-0013-qa-evidence.md).
