...
предмет [лекции 10](../modules/module-10-pm-specification/README.md).
...
Наш reducer принимает code-created команду; доверие к создающему её слою
нельзя получить из самого payload. Механизмы identity/authorization —
...
цикла раскрывается в [лекции 12](../modules/module-12-data-engineer/README.md)
и [лекции 18](../modules/module-18-recovery-idempotency/README.md).
...
Хранение и recovery — отдельная тема [17](../modules/module-17-state-memory/README.md).
...
принадлежит [лекции 11](../modules/module-11-analyst-provenance/README.md);
...
- Malformed payload нельзя разобрать как ожидаемое представление.
- Extra field разбирается, но нарушает закрытую схему.
...
[Лекция 04](../modules/module-04-harness-context/README.md) рассматривает harness
