# TODO — Лекция 11. Analyst: discovery, lineage и provenance фактов

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0011-analyst-provenance.md` (ещё не написан).
...
Prerequisites: [08](LECTURE-0008-dbt-semantics.md), [17](LECTURE-0017-state-memory.md).
...
Не пересказывать theory владельцев: [08](LECTURE-0008-dbt-semantics.md), [10](LECTURE-0010-pm-specification.md), [17](LECTURE-0017-state-memory.md).
