...
С лекции 14 применяется text-only schema v2: Markdown, факты, ссылки и
семантика исходного текста схем, без скриншотов и browser/visual review.
Ранее созданные receipts v1 сохраняют историческое visual evidence; machine
render/build fingerprint новых лекций не считается визуальной вычиткой.
