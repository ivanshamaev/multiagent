...
[Todo-план](../../../plan/steps/lections/LECTURE-0007-agent-orchestrator.md) · [Manifest](../../manifest.json) · [Технические требования](../../technical-requirements.md)
...
Будущий текст: `course/lectures/LECTURE-0007-agent-orchestrator.md`; outline не лекция.
