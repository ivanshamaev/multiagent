# TODO — Лекция 18. Recovery: checkpoints, receipts и пределы exactly-once

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0018-recovery-idempotency.md` (ещё не написан).
...
Prerequisites: [15](LECTURE-0015-strict-workflow.md), [17](LECTURE-0017-state-memory.md).
...
Не пересказывать theory владельцев: [09](LECTURE-0009-airflow-operations.md), [15](LECTURE-0015-strict-workflow.md), [17](LECTURE-0017-state-memory.md), [22](LECTURE-0022-failure-taxonomy.md).
