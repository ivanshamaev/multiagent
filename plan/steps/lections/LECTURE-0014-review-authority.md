# TODO — Лекция 14. Reviewer: quality judgment и separation от автора

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0014-review-authority.md` (ещё не написан).
...
Prerequisites: [13](LECTURE-0013-qa-evidence.md).
...
Не пересказывать theory владельцев: [01](LECTURE-0001-organization.md), [13](LECTURE-0013-qa-evidence.md), [21](LECTURE-0021-evaluation.md).
