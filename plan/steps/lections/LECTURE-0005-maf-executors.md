# TODO — Лекция 05. MAF: executors, edges и runtime графа

Status: reviewed; publication gate complete

Updated: 2026-09-17

Текст: `course/lectures/LECTURE-0005-maf-executors.md`.
...
Prerequisites: [02](LECTURE-0002-contracts.md), [04](LECTURE-0004-state-memory.md).

## Что писать — todo

- [x] Разобрать executor как runtime unit и edge как путь доставки, отдельно от бизнес-перехода.
- [x] Объяснить graph state/messages и границу adapter/domain reducer.
- [x] Показать typed JSON boundary в six-role graph и значение graph signature.
- [x] Сравнить framework abstractions без рейтинга stars, неподтверждённых API обещаний и SDK tutorial.
...
Не пересказывать theory владельцев: [02](LECTURE-0002-contracts.md), [06](LECTURE-0006-strict-workflow.md), [17](LECTURE-0017-recovery-idempotency.md).
