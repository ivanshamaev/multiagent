# TODO — Лекция 06. MCP как интерфейс, а не политика координации

Status: planned

Updated: 2026-09-15

Текст: `course/lectures/LECTURE-0006-mcp-interface.md` (ещё не написан).
...
Prerequisites: [05](LECTURE-0005-isolation.md), [04](LECTURE-0004-harness-context.md).
...
Не пересказывать theory владельцев: [07](LECTURE-0007-analytical-sql.md), [08](LECTURE-0008-dbt-semantics.md), [09](LECTURE-0009-airflow-operations.md), [19](LECTURE-0019-security-authority.md).
